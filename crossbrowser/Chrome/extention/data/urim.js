...
(function() {
  ...
  UrimSandbox = (function() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        request.onload = function() {
          if (request.status === 200) {
            ...
            return reject(Error('Resourse didn\'t load successfully; error code:' + request.statusText));
          }
        };
    ...
    function UrimSandbox(onload) {
      var detach_cb, get_selection_cb, is_this_worker_alive, promises;
      ...
      this.options = make_options();
      promises = Promise.all([loadData('data/css/iframes.css'), loadData('data/css/li.css'), loadData('data/css/sidebar.css')]);
      promises.then((function(_this) {
        return function(values) {
          var opts;
          opts = _this.options;
          opts.cssiframes = values[0], opts.cssli = values[1], opts.csssidebar = values[2];
          return typeof onload === "function" ? onload() : void 0;
        };
      })(this));
      promises["catch"](function(exeption) {
        return console.warn(exeption);
      });
    }
  ...
  urim_sandbox = new UrimSandbox(function() {
    ...
    return urim_sandbox.emit_get_selection();
  });
