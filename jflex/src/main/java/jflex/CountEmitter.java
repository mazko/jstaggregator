...
//			println("    offset = zzUnpack" + name + "(" + constName()
//					+ "_PACKED_" + i + ", offset, result);");
			println("    offset = zzUnpack" + name + "_helper(" + constName()
					+ "_PACKED_" + i + ", offset, result);");
		}
...
//		println("      int value = packed.charAt(i++);");
	 ...
	 * 
	 * @param i
	 *            amount the value will be translated by. Example:
	 *            <code>i = 1</code> allows values in [-1, 0xFFFE].
	 */
