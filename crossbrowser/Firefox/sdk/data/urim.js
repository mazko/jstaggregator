...
(function() {
  var FlagWidget, SidebarWidget, UrimSandbox, UrimWidget, urim_sandbox, widget_flag, widget_sidebar,
  ...
  UrimSandbox = (function() {
    function UrimSandbox() {
      ...
      this.is_worker_alive = function(cb) {
  ...
  urim_sandbox.on_self_got_selection(function(plain_text) {
    var async, htmlBodyToText, lng, tokenStream, tokensMap;
