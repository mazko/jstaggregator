...
javac -cp lucene-analyzers-common-4.1.0.jar:lucene-core-4.1.0.jar java/LuceneStopFetcher.java

#start fetching stop words from Lucene
LuceneStopFetcher="java -cp java:java.LuceneStopFetcher:lucene-analyzers-common-4.1.0.jar:lucene-core-4.1.0.jar LuceneStopFetcher"
...
#cleanup
rm java/LuceneStopFetcher.class lucene-analyzers-common-4.1.0.jar lucene-core-4.1.0.jar
