 ...
 * 
 * Also splits up strings when longer than 64K in UTF8 encoding. Subclasses emit
 * unpacking code.
 * 
 * Usage protocol: <code>p.emitInit();</code><br>
 * <code>for each data: p.emitData(data);</code><br>
 * <code>p.emitUnpack();</code>
 * 
 * @author Gerwin Klein
 * @version $Revision: 586 $, $Date: 2010-03-07 10:59:36 +0200 (Вск, 07 Мар
 *          2010) $
 */
...
//		nl();
	...
	/**
	 * Execute line/chunk break if necessary. Leave space for at least two
	 * chars.
	 */
	public void breaks() {
...
//		out.append("  private static final String ");
	...
	private int UTF8Length(char value) {
		// if (value < 0 || value > 0xFFFF) throw new
		// Error("not a char value ("+value+")");
